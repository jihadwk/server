 package com.wk.util;
 /**
  * checksum 总和校验码：远距离通信中保证数据的完整性和准确性
  * Adler-32是Mark Adler提出的一种校验和算法，与同等长度的CRC校验算法相比，它具有更好的执行效率。与此同时，
  * 它比Fletcher-16可靠，但稍逊于Fletcher-32。
  * 客户端传校验码，服务端收到消息后生成校验码，比较之后可以判断数据是否完整或被修改
  * @author wukai
  *
  */
